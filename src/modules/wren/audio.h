...
{
  wrenSetSlotDouble(vm, 0, AUDIO_STATIC);
}
static void wren_audio_stream(WrenVM *vm)
{
  wrenSetSlotDouble(vm, 0, AUDIO_STREAM);
}
...
static tc_wren_lib wrenAudioLib[] = {
...
static tc_wren_lib wrenSoundLib[] = {
